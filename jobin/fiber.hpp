...
private:
  ...
  template <unsigned int size> friend class fiber_pool_fixed;

  friend fiber *create_fiber();
  friend void init_fiber(fiber *fib, void (*handle)(void *), void *args);
  friend void convert_thread_to_fiber(fiber *fib, void (*handle)(void *),
                                      void *arg);
...
#elif FIBER_WINDOWS_BACKEND
  fiber()
      : ctx{nullptr}, stack{nullptr}, handle{nullptr}, stack_size{0}, args{0} {}
#elif FIBER_EMSCRIPTEN_BACKEND
  fiber()
      : stack{nullptr}, handle{nullptr}, stack_size{0}, args{0}, allocator{
                                                                     nullptr} {}
#elif FIBER_CROSS_BACKEND
